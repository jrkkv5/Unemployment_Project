...
```
This plot represents the relationship between Illinois' median housing price index (HPI) and the year. From 1984 to 2008 the relationship appeared to be linear, until the HPI dipped from 2008-2013. Since then, the HPI has began to increase in a linear relationship again. This pattern is displayed consistently when observing the proceeding states and, through inference, can partially be attributed to the housing crisis that occurred in 2008 and 2009. 
