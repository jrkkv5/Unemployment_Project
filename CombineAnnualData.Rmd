...
``` {r testframe}
test <- HPI_Population_Unemp_MHI_poverty_Combined_Annual[ HPI_Population_Unemp_MHI_poverty_Combined_Annual$state == "AK", ]

as.numeric(test$population)

poplimit <- c(0 , 900000)
plot(test$year, test$population, ylim = poplimit)
```
